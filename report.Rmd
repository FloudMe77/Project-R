...
rb2RPS <- as.vector(read.csv("./data/rosenbrock_2dRPS.csv"))$x
rb10GA <- as.vector(read.csv("./data/rosenbrock_10dGA.csv"))$x
rb10RPS <- as.vector(read.csv("./data/rosenbrock_10dRPS.csv"))$x
rb20GA <- as.vector(read.csv("./data/rosenbrock_20dGA.csv"))$x
rb20RPS <- as.vector(read.csv("./data/rosenbrock_20dRPS.csv"))$x

<!-- jakoś to tutaj może pójdzie  -->
<!-- results <- as.data.frame(read.csv("./data/results.csv"))$x -->
...
```{r echo=FALSE}
generate_plot(rb2PRS,"rosenbrock_2d","RPS")
```
...
```{r echo=FALSE}
generate_plot(rb10PRS,"rosenbrock_10d","RPS")
```
...
```{r echo=FALSE}
generate_plot(rb20PRS,"rosenbrock_20d","RPS")
```
...
```{r echo=FALSE}
generate_plot(ra2PRS,"rastrigin_2d","RPS")
```
...
```{r echo=FALSE}
generate_plot(ra10PRS,"rastrigin_10d","RPS")
```
...
```{r echo=FALSE}
generate_plot(ra20PRS,"rastrigin_20d","RPS")
```
